...
import AddFamilyRecord from './pages/AddFamilyRecord'
import DoctorAppointmentChat from './pages/DoctorAppointmentChat'
  ...
  return (
    <div className='mx-4 sm:mx[10%]'>
      ...
      <Routes>
        ...
        <Route path='/doctor-appointment-chat/:doctorId/:appointmentId' element={<DoctorAppointmentChat />} />
