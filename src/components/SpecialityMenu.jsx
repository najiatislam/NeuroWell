...
const SpecialityMenu = () => {
  return (
    <div className='flex flex-col items-center gap-4 py-16 text-slate-800' id='speciality'>
        <h1 className='text-3xl font-medium'> Specialist We provide</h1>
        <p className='sm:w-1/3 text-center text-sm'>Browse throught the Specialist we provide and schedule your appointment hassle free !</p>
