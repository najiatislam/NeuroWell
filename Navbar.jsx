        ...
        <div className='flex items-center justify-between text-sm py-4 mb-6 border-b border-b-gray-700 px-4 md:px-10 lg:px-20' >
            ...
            <ul className='hidden md:flex items-start gap-5 font-medium' >
                ...
                <NavLink to='/' >
                    ...
                    <hr className='broder-none outline-none h-0.5 bg-slate-600 w-3/5 m-auto hidden ' />
                </NavLink>
            ...
            <div className='flex items-center gap-4'>
                {
                    token
                        ...
                        : <button onClick={() => navigate('/login')} className='bg-slate-600 text-white px-6 py-1 rounded-full font-light hidden md:block'>Create Account</button>
